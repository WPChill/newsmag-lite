 ...
 */
$banner_image = get_theme_mod( 'newsmag_banner_image', get_template_directory_uri() . '/images/banner.jpg' );
 ...
 */
if ( get_theme_mod( 'newsmag_banner_image', get_template_directory_uri() . '/images/banner.jpg' ) !== get_template_directory_uri() . '/images/banner.jpg' ) {
