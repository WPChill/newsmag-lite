...
class Widget_Newsmag_Banner extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$before_widget = str_replace( 'class="', 'class="newsmag-type-' . $params['banner_type'][0] . ' ', $before_widget );
		echo $before_widget;
	...
	public function form( $instance ) {
		...
		wp_enqueue_script( 'newsmag_media_upload_js', get_stylesheet_directory_uri() . '/js/upload-media.js', array( 'jquery' ) );
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'newsmag' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'show_title' ); ?>"><?php _e( 'Show Title', 'newsmag' );
				?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'banner_type' ); ?>"><?php _e( 'Banner Type', 'newsmag' );
				?>:</label>
		...
		<p>
			<label for="<?php echo $this->get_field_name( 'image' ); ?>"><?php _e( 'Image:', 'newsmag' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'adsense_code' ); ?>"><?php _e( 'Adsense Code:', 'newsmag' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'image_url' ); ?>"><?php _e( 'Image URL:', 'newsmag' ); ?></label>
