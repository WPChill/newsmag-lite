...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Epsilon_Control_Checkbox_Multiple extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'newsmag-customize-controls', trailingslashit( get_template_directory_uri() ) . 'inc/libraries/epsilon-framework/assets/js/checkbox-multiple.js', array( 'jquery' ) );
		}
