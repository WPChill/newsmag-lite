...
/**
 * Class Widget_Newsmag_Posts_Video_Grid
 */
class Widget_Newsmag_Posts_Video_Grid extends WP_Widget {
	/*
	 * Constructor
	 */
	function __construct() {
		...
		parent::__construct( 'newsmag_widget_posts_video_grid', __( 'Newmsag - Video posts grid', 'newsmag' ), array(
			'classname'                   => 'newsmag_builder newsmag_widget_posts_video grid',
	...
	public function widget( $args, $instance ) {
		...
		if ( $new_query->have_posts() ):
			include get_template_directory() . '/inc/libraries/widgets/widget-newsmag-posts-video-grid/layouts/default.php';
		endif;
