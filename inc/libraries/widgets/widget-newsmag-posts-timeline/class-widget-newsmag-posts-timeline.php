...
/**
 * Class Widget_Newsmag_Posts_Timeline
 */
class Widget_Newsmag_Posts_Timeline extends WP_Widget {
	/*
	 * Constructor
	 */
	function __construct() {
		...
		parent::__construct( 'newsmag_widget_posts_timeline', __( 'Newmsag - Posts timeline', 'newsmag' ), array(
			'classname'                   => 'newsmag_builder newsmag_widget_posts_timeline',
			'description'                 => __( 'Add a posts timeline widget.', 'newsmag' ),
	...
	public function widget( $args, $instance ) {
		...
		if ( $new_query->have_posts() ):
			include get_template_directory() . '/inc/libraries/widgets/widget-newsmag-posts-timeline/layouts/default.php';
		endif;
